...
/**
 * A value object that acts as a screenshot of the Domain's (originator) state.
 *
 * @author Lucy Goodwin
 */
public class GameMemento {
    ...
    /**
     * The level number and time left in the game to be captured.
     */
    ...
    /**
     * Called when the memento has been restored in the Domain and handed back to the App module.
     *
     * @return int level number of game being restored
     */
     ...
     * Called when the memento has been restored in the Domain and handed back to the App module.
     *
     * @return int time left in game being restored
     */
    ...
    /**
     * Called when the memento has been generated by the Domain with information from the App module.
     *
     * @param levelNumber int level number of game to be captured
     */
     ...
     * Called when the memento has been generated by the Domain with information from the App module.
     *
     * @param timeLeft int time left in game to be captured
     */
