...
public final class CopperKey extends KeyTile {
	...
	public void entityEntered(GameObject o) {
		if(o instanceof Chip) ((Chip)o).addItem(new KeyItem("Copper"));
	}
	@Override
	public void undoEntityActions(GameObject o) {
		if(o instanceof Chip) ((Chip)o).removeItem(new KeyItem("Copper"));
	}
	
	@Override
	public String toString() { return super.toString()+" Copper"; }
}
