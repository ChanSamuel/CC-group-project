...
public final class GreenKey extends KeyTile {
	...
	public void entityEntered(GameObject o) {
		if(o instanceof Chip) ((Chip)o).addItem(new KeyItem("Green"));
	}
	@Override
	public void undoEntityActions(GameObject o) {
		if(o instanceof Chip) ((Chip)o).removeItem(new KeyItem("Green"));
	}
	
	@Override
	public String toString() { return super.toString()+" Green"; }
}
