...
public class WorldJPanel extends JPanel implements MainJPanel {
	...
	/**
	 * Set the domain and level,board, playerCoord,
	 * remove and re-validate all the old JPanels,
	 * start play music of current level,
	 * set the properties of current JPanel, 
	 * update focus area and initialize all the JPanels and add to itself.
	 * 
	 * @param domain
	 * @param level 
	 */
	 ...
	 * it actually moving this JPanel to the opposite direction of chap.
	 */
	...
	public Coord getHeroCoord() {
		if (domain.getDomainState() instanceof Loading)
			return null;
	 ...
	 * chip, pick up a key, open the door etc. occurs.
	 * 
