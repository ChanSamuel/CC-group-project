...
/**
 * The GUIController is where the majority of the code for the GUI is held. On
 * construction and subsequent call of the run() method, this class will have
 * action listeners for the keyboard, and appropriately displayed components.
...
public class GUIController extends GUI {
  ...
  /**
   * Add all the listeners for the buttons, and menu items.
   */
  private void addListeners() {

    // Add a mouse listener to the frame so that we can always click to request back
    // focus.
  ...
  /**
   * Helper method for clearing the text panel.
   */
  ...
  /**
   * Helper method which requests focus back into the frame. This is needed when
   * after text has been entered into the changeSpeed text box.
   */
